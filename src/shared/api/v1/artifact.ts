...
class CreateArtifactResponse$Type extends MessageType<CreateArtifactResponse> {
  ...
  create(
    value?: PartialMessage<CreateArtifactResponse>
...
class FinalizeArtifactRequest$Type extends MessageType<FinalizeArtifactRequest> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue hash */ 5:
          message.hash = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.hash
  ...
  internalBinaryWrite(
    ...
    if (message.name !== '')
      writer.tag(3, WireType.LengthDelimited).string(message.name)
    /* int64 size = 4; */
    if (message.size !== '0') writer.tag(4, WireType.Varint).int64(message.size)
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue name_filter */ 3:
          message.nameFilter = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.nameFilter
        ...
        case /* google.protobuf.Int64Value id_filter */ 4:
          message.idFilter = Int64Value.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.idFilter
...
class ListArtifactsResponse$Type extends MessageType<ListArtifactsResponse> {
      ...
      switch (fieldNo) {
        case /* repeated github.actions.results.api.v1.ListArtifactsResponse.MonolithArtifact artifacts */ 1:
          message.artifacts.push(
            ListArtifactsResponse_MonolithArtifact.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.artifacts.length; i++)
      ListArtifactsResponse_MonolithArtifact.internalBinaryWrite(
        message.artifacts[i],
...
class ListArtifactsResponse_MonolithArtifact$Type extends MessageType<ListArtifactsResponse_MonolithArtifact> {
  constructor() {
    super(
      'github.actions.results.api.v1.ListArtifactsResponse.MonolithArtifact',
      [
        {
          no: 1,
          name: 'workflow_run_backend_id',
  ...
  create(
    value?: PartialMessage<ListArtifactsResponse_MonolithArtifact>
    ...
    if (value !== undefined)
      reflectionMergePartial<ListArtifactsResponse_MonolithArtifact>(
        this,
        message,
        value
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListArtifactsResponse_MonolithArtifact
  ): ListArtifactsResponse_MonolithArtifact {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    ...
    /* int64 size = 5; */
    if (message.size !== '0') writer.tag(5, WireType.Varint).int64(message.size)
 ...
 */
export const ListArtifactsResponse_MonolithArtifact =
  new ListArtifactsResponse_MonolithArtifact$Type()
// @generated message type with reflection information, may provide speed optimized methods
class GetSignedArtifactURLRequest$Type extends MessageType<GetSignedArtifactURLRequest> {
  ...
  create(
    value?: PartialMessage<GetSignedArtifactURLRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetSignedArtifactURLRequest
  ): GetSignedArtifactURLRequest {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
 ...
 */
export const GetSignedArtifactURLRequest =
  new GetSignedArtifactURLRequest$Type()
// @generated message type with reflection information, may provide speed optimized methods
class GetSignedArtifactURLResponse$Type extends MessageType<GetSignedArtifactURLResponse> {
  ...
  create(
    value?: PartialMessage<GetSignedArtifactURLResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetSignedArtifactURLResponse
  ): GetSignedArtifactURLResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
 ...
 */
export const GetSignedArtifactURLResponse =
  new GetSignedArtifactURLResponse$Type()
// @generated message type with reflection information, may provide speed optimized methods
...
class DeleteArtifactResponse$Type extends MessageType<DeleteArtifactResponse> {
  ...
  create(
    value?: PartialMessage<DeleteArtifactResponse>
 ...
 */
export const ArtifactService = new ServiceType(
  ...
  [
    ...
    },
    {
      ...
      options: {},
      I: GetSignedArtifactURLRequest,
      O: GetSignedArtifactURLResponse
    },
    {
      name: 'DeleteArtifact',
      options: {},
